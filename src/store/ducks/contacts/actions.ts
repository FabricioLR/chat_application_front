...
import { AddContactPayload, Contact, ContactsTypes, FilterPayload } from "./types"
...
export const filterRequest = (payload: FilterPayload) => action(ContactsTypes.FILTER_REQUEST, { payload })
